...
import { handleDetail } from '../ServiceDetail';
                                ...
                                >
                                    ...
                                    <td>
                                        <div className={tb('notiResult')}>
                                            ...
                                            <p>{service.status === false ? 'Ngưng hoạt động' : 'Hoạt động'}</p>
                                        </div>
                                    </td>
                                    <td>
                                        <Button link to="/serviceDetail" onClick={() => handleDetail(service.id)}>
                                            <p className={cx('table-results-detail')}>Chi tiết</p>
                                        </Button>
                                    </td>
                                    <td>
                                        <Button link to="/serviceDetail">
